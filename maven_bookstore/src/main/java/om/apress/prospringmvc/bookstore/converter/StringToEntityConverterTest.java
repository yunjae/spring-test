package om.apress.prospringmvc.bookstore.converter;
...
public class StringToEntityConverterTest implements GenericConverter {
    ...
    public StringToEntityConverterTest(Class<?> clazz) {
        super();
        this.clazz = clazz;
    }

...
public class MeneyTransperSpring {
	
		private static final Logger logger = LoggerFactory.getLogger(MeneyTransperSpring.class);
		...
		public static void main(String[] args) {
			   ...
			   System.out.println(System.getProperty("spring.profiles.active"));
				...
				System.setProperty("spring.profiles.active", "test");
				System.out.println(System.getProperty("spring.profiles.active"));
				ApplicationContext ctx2 = new ClassPathXmlApplicationContext("/com/apress/prospringmvc/moneytransfer/annotation/profile/application-context.xml");				
				transfer(ctx2);
